...
// RS232_Binary.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CRS232BinaryApp, CWinApp)
...
CRS232BinaryApp::CRS232BinaryApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CRS232BinaryApp 物件

CRS232BinaryApp theApp;


// CRS232BinaryApp 初始化

BOOL CRS232BinaryApp::InitInstance()
{
